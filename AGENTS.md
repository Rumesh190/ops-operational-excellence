# AGENTS.md — OPS Codex Engineering & Product Rules

> This file defines the permanent engineering, architecture, UX, workflow, and
> agent-behavior rules for Codex working on the OPS project.
>
> Codex should operate as an implementation agent: inspect the repository,
> make focused edits when implementation is requested, validate the work, and
> report concise results. Do not stop at a plan unless the user asked for one.
>
